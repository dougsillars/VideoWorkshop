...
<body>
  <div class="container p-4 col-12 col-md-9 col-xl-6">
    <nav class="nav mb-2">
      <a href="../index.html">
        << Back to examples index</a> </nav> <h1>Cloudinary Video Player</h1>
          <h3 class="mb-4">Subtitles & Captions</h3>

          <video id="player" playsinline controls muted autoplay class="cld-video-player cld-fluid" width="500"></video>
