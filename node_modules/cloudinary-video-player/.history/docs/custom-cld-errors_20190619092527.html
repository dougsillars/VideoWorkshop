      ...
      player = cld.videoPlayer('player', {
       ...
       player.on('error', (e) => {
         if (e.Player.videojs.error_.code === 11) {
           var error = document.createElement('div').textContent="Error !!!!!!!!! " + e.Player.videojs.error_.message;
           error.style.color = 'red';
           document.querySelector(".cld-video-player").appendChild(error);
         }
       })
  ...
  <div class="container p-4 col-12 col-md-9 col-xl-6">
    ...
    <pre>
      ...
      player = cld.videoPlayer('player', {
       ...
       player.on('error', (e) => {
         if (e.Player.videojs.error_.code === 11) {
           var title = document.querySelector("h3.mb-4");
           title.innerHTML = "Error !!!!!!!!! " + e.Player.videojs.error_.message;
